...
const Transfer = ({selectedToken, setAction, thirdWebTokens, walletAddress}) => {
  ...
  useEffect(() => {
    const activeToken = thirdWebTokens.find(
      token => token.address === selectedToken.contractAddressk
      )
    ...
    //     console.log(balance.displayValue,'balance here')
    //   }
  ...
  return (
    <Wrapper>
        ...
        <Row>
            ...
            {/* <BalanceTitle>BTC Balance</BalanceTitle>
            <Balance>7 BTC</Balance> */}
        </Row>
    </Wrapper>
  )
}
